    ...
    var write_num = (function make_write_num() {
      ...
      function write_num_f1(r, aval, sign) {
        ...
        var myn = rr - base * den,
          myd = den;
        return (
          sign + (base === 0 ? '' : '' + base) + ' ' + (myn === 0 ? fill(' ', r[1].length + 1 + r[4].length) : pad_(myn, r[1].length) + r[2] + '/' + r[3] + pad0(myd, r[4].length))
        );
      }
      ...
      while (i < fmt.length) {
        switch ((c = fmt.charAt(i))) {
          ...
          case '涓�':
            ...
            if (fmt.substr(i, 5).toUpperCase() === '涓婂崍/涓嬪崍') return true;
            ++i;
            break;
          case '[':
            o = c;
        ...
        switch ((c = fmt.charAt(i))) {
          ...
          case '涓�':
            ...
            if (fmt.substr(i, 3).toUpperCase() === 'A/P') {
              ...
              i += 5;
              hr = 'h';
            } else if (fmt.substr(i, 5).toUpperCase() === '涓婂崍/涓嬪崍') {
              if (dt != null) q.v = dt.H >= 12 ? '涓嬪崍' : '涓婂崍';
              q.t = 'T';
              i += 5;
              hr = 'h';
            } else {
...
*/
  ...
  var _XLSIcv = rgbify([
    ...
    0xffffff /* 0x40 icvForeground ?? */, 0x000000 /* 0x41 icvBackground ?? */, 0x000000 /* 0x42 icvFrame ?? */, 0x000000 /* 0x43 icv3D ?? */, 0x000000 /* 0x44 icv3DText ?? */,
    0x000000 /* 0x45 icv3DHilite ?? */, 0x000000 /* 0x46 icv3DShadow ?? */, 0x000000 /* 0x47 icvHilite ?? */, 0x000000 /* 0x48 icvCtlText ?? */, 0x000000 /* 0x49 icvCtlScrl ?? */,
    0x000000 /* 0x4A icvCtlInv ?? */, 0x000000 /* 0x4B icvCtlBody ?? */, 0x000000 /* 0x4C icvCtlFrame ?? */, 0x000000 /* 0x4D icvCtlFore ?? */, 0x000000 /* 0x4E icvCtlBack ?? */,
    0x000000 /* 0x4F icvCtlNeutral */, 0x000000 /* 0x50 icvInfoBk ?? */, 0x000000 /* 0x51 icvInfoText ?? */,
  ]);
  ...
  var WK_ = (function () {
    ...
    var oprec = [8, 8, 8, 8, 8, 8, 8, 8, 6, 4, 4, 5, 5, 7, 3, 3, 3, 3, 3, 3, 1, 1, 2, 6, 8, 8, 8, 8, 8, 8, 8, 8];
    /* TODO: flesh out */
    var FuncTab = {
      0x33: ['FALSE', 0],
      0x34: ['TRUE', 0],
  ...
  var crypto_CreateXorArray_Method1 = (function () {
    ...
    var XorMatrix = [
      0xaefc, 0x4dd9, 0x9bb2, 0x2745, 0x4e8a, 0x9d14, 0x2a09, 0x7b61, 0xf6c2, 0xfda5, 0xeb6b, 0xc6f7, 0x9dcf, 0x2bbf, 0x4563, 0x8ac6, 0x05ad, 0x0b5a, 0x16b4, 0x2d68, 0x5ad0,
      0x0375, 0x06ea, 0x0dd4, 0x1ba8, 0x3750, 0x6ea0, 0xdd40, 0xd849, 0xa0b3, 0x5147, 0xa28e, 0x553d, 0xaa7a, 0x44d5, 0x6f45, 0xde8a, 0xad35, 0x4a4b, 0x9496, 0x390d, 0x721a,
      0xeb23, 0xc667, 0x9cef, 0x29ff, 0x53fe, 0xa7fc, 0x5fd9, 0x47d3, 0x8fa6, 0x0f6d, 0x1eda, 0x3db4, 0x7b68, 0xf6d0, 0xb861, 0x60e3, 0xc1c6, 0x93ad, 0x377b, 0x6ef6, 0xddec,
      0x45a0, 0x8b40, 0x06a1, 0x0d42, 0x1a84, 0x3508, 0x6a10, 0xaa51, 0x4483, 0x8906, 0x022d, 0x045a, 0x08b4, 0x1168, 0x76b4, 0xed68, 0xcaf1, 0x85c3, 0x1ba7, 0x374e, 0x6e9c,
      0x3730, 0x6e60, 0xdcc0, 0xa9a1, 0x4363, 0x86c6, 0x1dad, 0x3331, 0x6662, 0xccc4, 0x89a9, 0x0373, 0x06e6, 0x0dcc, 0x1021, 0x2042, 0x4084, 0x8108, 0x1231, 0x2462, 0x48c4,
    ];
...
*/
  ...
  function write_xls_props(wb, cfb) {
    ...
    if (wb.Props) {
      ...
      for (i = 0; i < Keys.length; ++i)
        (Object.prototype.hasOwnProperty.call(DocSummaryRE, Keys[i]) ? DSEntries : Object.prototype.hasOwnProperty.call(SummaryRE, Keys[i]) ? SEntries : CEntries).push([
          Keys[i],
          wb.Props[Keys[i]],
        ]);
    }
    ...
    if (DSEntries.length || CEntries2.length)
      CFB.utils.cfb_add(
        ...
        write_PropertySetStream(DSEntries, PSCLSID.DSI, DocSummaryRE, DocSummaryPIDDSI, CEntries2.length ? CEntries2 : null, PSCLSID.UDI)
      );
  }
  ...
  function parse_xlscfb(cfb, options) {
    ...
    if (options.bookProps && !options.bookSheets) WorkbookP = {};
      ...
      /* Works 4 for Mac */ else if ((_data = CFB.find(cfb, 'MN0')) && _data.content) throw new Error('Unsupported Works 4 for Mac file');
  ...
  var NUMBERS = !Object.defineProperty
    ? void 0
    : (function () {
        ...
        var book_append_sheet = function (wb, ws, name) {
          if (!name)
            for (var i = 1; i < 9999; ++i) {
              if (wb.SheetNames.indexOf((name = 'Sheet '.concat(i))) == -1) break;
            }
  ...
  function write_zip_denouement(z, o) {
    ...
    var out = z.FullPaths
      ? CFB.write(z, { fileType: 'zip', type: { nodebuffer: 'buffer', string: 'binary' }[oopts.type] || oopts.type, compression: !!o.compression })
      : z.generate(oopts);
    if (typeof Deno !== 'undefined') {
